<?php
/**
 * File for class MpesaStructTransactionStatusRequest
 * @package Mpesa
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MpesaStructTransactionStatusRequest originally named transactionStatusRequest
 ...
 * @date 2015-05-30
 */
class MpesaStructTransactionStatusRequest extends MpesaWsdlClass
{
    /**
     * The TRX_ID
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for transactionStatusRequest
     * @see parent::__construct()
     * @param string $_tRX_ID
     * @param string $_mERCHANT_TRANSACTION_ID
     * @return MpesaStructTransactionStatusRequest
     */
